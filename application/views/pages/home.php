    ...
    <div class="carousel-inner">
        <div class="item" onclick="location.href='<?php echo base_url();?>product'">
            ...
            <div class="carousel-caption">
                ...
                <p> Do a Kick Flip or some serious Technical Skating on Motion Board 1984</p>
            </div>
        </div>
        <div class="item" onclick="location.href='<?php echo base_url();?>product'">
            ...
            <div class="carousel-caption">
                <h3> Carve </h3>
                <p> Carve your new style on Motion 1984.</p>
            </div>
        </div>
        ...
        <div class="item active" onclick="location.href='<?php echo base_url();?>product'">
            ...
            <div class="carousel-caption">
                <h3>PRO Skate Board Motion 1984</h3>
                <p> Do all your cool stuff on Contoso board Motion 1984.</p>
            </div>
        </div>
    </div>
<!-- Controls -->
